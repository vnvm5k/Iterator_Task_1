...
test('Iterator', () => {
  ...
  const teamIterator = newTeam[Symbol.iterator]();

  expect(teamIterator.next()).toEqual({ done: false, value: swordsman });
  expect(teamIterator.next()).toEqual({ done: false, value: bowman });
